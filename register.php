...
<html>
	<head>
		...
		<title>Register | Take A Quiz</title>
			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
							<center> <h5 style="font-family: Noto Sans;">Register to </h5><h4 style="font-family: Noto Sans;">Take A Quiz</h4></center><br>
							<form method="post" action="register.php" enctype="multipart/form-data">
								...
								<div class="form-group text-center">
									<span class="text-muted">Already have an account! </span> <a href="login.php" style="color:teal;">Login </a> Here..
								</div>
							</form>
						</div>
					</div>
